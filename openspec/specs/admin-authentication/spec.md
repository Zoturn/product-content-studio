...
## Purpose
The trust boundary the rest of the application depends on: who may reach the administrative area, how they prove it, how that proof is carried in a session cookie and ended, and what an unauthorised caller — whether a browser or a direct API request — is told instead.
## Requirements
