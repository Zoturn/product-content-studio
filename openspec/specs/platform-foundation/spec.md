...
## Purpose
The persistent data model this project is built on: the administrator account, the product content and status that both the admin editor and the public catalog read, and the guarantee that a save outlives an application restart.
## Requirements
